    ...
    return (
        ...
        >
            ...
            <div className="relative w-full h-40 mb-3 flex-shrink-0">
                <Image
                    src={`https://res.cloudinary.com/dkj7padnu/image/upload/f_avif,q_55,w_350,h_250,c_fit/tnlp/products/${image.replace('img/products/', '').replace('img/products/office/', 'office/')}`}
                    alt={title}
                    fill
                    sizes="(max-width: 480px) 250px, (max-width: 768px) 320px, (max-width: 1200px) 350px, 320px"
