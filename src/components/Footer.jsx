...
const WhatsAppIcon = ({ className }) => (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M12.04 2C6.58 2 2.13 6.45 2.13 11.91c0 1.79.46 3.48 1.32 4.95L2 22l5.25-1.38c1.41.79 3.02 1.22 4.79 1.22h.01c5.46 0 9.91-4.45 9.91-9.91S17.5 2 12.04 2zm4.88 13.38c-.27.53-1.35.94-1.85 1.03-.5.09-1.02.18-1.54.18-.52 0-1.35-.18-2.04-.46-.98-.36-2.04-.91-2.92-1.88s-1.52-1.94-1.88-2.92c-.27-.68-.46-1.52-.46-2.04s.09-.93.18-1.54c.09-.5.5-1.58 1.03-1.85.36-.27.78-.46 1.2-.46.42 0 .78.09 1.05.18.27.09.46.27.64.46.18.18.36.36.46.55.09.18.18.36.18.55v.18c0 .18-.09.36-.18.55l-.36.82c-.09.18-.18.36-.27.46-.09.09-.18.18-.36.18h-.18c-.09 0-.18-.09-.27-.18l-.36-.36c-.09-.09-.18-.18-.27-.18-.09 0-.18.09-.27.18l-.55.64c-.18.18-.36.36-.46.55-.09.18-.18.36-.18.55s.09.36.18.55l.55.64c.18.18.36.36.46.55.09.18.18.36.18.55s-.09.36-.18.55l-.36.82c-.09.18-.18.36-.27.46-.09.09-.18.18-.36.18h-.18c-.09 0-.18-.09-.27-.18l-.36-.36c-.09-.09-.18-.18-.27-.18-.09 0-.18.09-.27.18l-.55.64c-.18.18-.36.36-.46.55-.09.18-.18.36-.18.55s.09.36.18.55l.55.64c.18.18.36.36.46.55.09.18.18.36.18.55s-.09.36-.18.55l-.36.82c-.09.18-.18.36-.27.46-.09.09-.18.18-.36.18h-.18c-.09 0-.18-.09-.27-.18l-.36-.36c-.09-.09-.18-.18-.27-.18-.09 0-.18.09-.27.18l-.55.64c-.18.18-.36.36-.46.55-.09.18-.18.36-.18.55s.09.36.18.55l.55.64c.18.18.36.36.46.55.09.18.18.36.18.55z"/>
    </svg>
);

// Componente SVG para Email
...
const Footer = () => {
    return (
        <footer className='bg-black-tnlp text-white w-full py-12 px-4 sm:px-6 lg:px-4'>
            <div className='container '>
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 '>
                    ...
                    <div className="flex flex-col items-center md:items-center">
                        <a href="/#home" className="mb-4">
                            {/* Asumiendo que tienes una imagen de logo, de lo contrario usa texto */
                            /* Si usas Next.js Image (asegúrate que 'next/image' esté disponible):*/}
                            <Image
                                src="/img/logotnlp.png" // Asegúrate que esta ruta sea correcta
                                width={150}
                                height={150}
                    ...
                    <div className="text-center md:text-center">
                        ...
                        <ul className="space-y-3 text-gray-300 ml-14">
                            <li className="flex items-center justify-center md:justify-start">
                                <MapPinIcon className="mr-3 text-xl text-blue-400 flex-shrink-0 w-5 h-5" /> {/* Ajustado tamaño con w-5 h-5 */}
                                <span>Calle 56 Nº 1621, La Plata, Buenos Aires</span>
                            </li>
                            <li className="flex items-center justify-center md:justify-start">
                                <WhatsAppIcon className="mr-3 text-xl text-blue-400 flex-shrink-0 w-5 h-5" /> {/* Ajustado tamaño con w-5 h-5 */}
                                <a href="tel:+542216767615" className="hover:text-blue-400 transition-colors duration-300">221 676 7615</a>
                            </li>
                            <li className="flex items-center justify-center md:justify-start">
                                <MailIcon className="mr-3 text-xl text-blue-400 flex-shrink-0 w-5 h-5" /> {/* Ajustado tamaño con w-5 h-5 */}
                    ...
                    <div className="text-center ">
                        ...
                        <div className='flex justify-center md:justify-center space-x-4'>
                            <a target='_blank' rel="noopener noreferrer" href={'https://www.instagram.com/tunotebooklaplata/'} aria-label="Instagram">
                                <InstagramIcon className="text-3xl text-gray-300 hover:text-pink-500 transition-colors duration-300 w-7 h-7" /> {/* Ajustado tamaño con w-7 h-7 */}
                            </a>
                            <a target='_blank' rel="noopener noreferrer" href={'https://www.facebook.com/notebooklp/'} aria-label="Facebook">
                                <FacebookIcon className="text-3xl text-gray-300 hover:text-blue-600 transition-colors duration-300 w-7 h-7" /> {/* Ajustado tamaño con w-7 h-7 */}
                            </a>
                ...
                <div className="mt-10 pt-8 border-t border-gray-700 text-center text-sm text-gray-500">
                    ...
                    <p className="mt-1">Diseñado con <span role="img" aria-label="corazón">❤</span> por TNLP</p> {/* Reemplaza con tu nombre o el de tu agencia, y emoji accesible */}
                </div>
            </div>
        </footer>
    );
